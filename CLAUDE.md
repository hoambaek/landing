...
- **표기 규칙 (2026-07-05 확립)**: em-dash(`—`) 금지 → 쉼표/마침표로 · 가운뎃점(`·`)은 한 줄에 1개까지 · 스크롤 큐(`↓`)는 히어로 하단 중앙 1곳만 허용(2026-09-24 대표 결정으로 금지 해제, 다른 섹션엔 넣지 않음) · 좌표/수온 등 정밀 수치는 실측·실시간 연동 값만 (임의 생성 금지)
