...
const BRANDBOOK_ACK_COPY = {
  ...
  body: [
    "Muse de Marée 브랜드 소개서를 요청해 주셔서 감사합니다. 요청은 잘 받았습니다.",
    "보내주신 정보를 확인한 뒤, 준비되는 대로 소개서를 이 메일로 보내드리겠습니다.",
    "소개서와 함께 곧 다시 인사드리겠습니다.",
  ],
};
...
> = {
  ...
  partner: {
    ...
    body: [
      "Muse de Marée 파트너십에 관심 가져 주셔서 감사합니다. 문의는 잘 받았습니다.",
  ...
  brandbook: {
    ...
    body: [
      ...
      "한국 남해 수심 30m에서 숙성하는 샴페인의 철학과 기록 방식, 퀴베 라인업과 파트너십 안내를 한 권에 담았습니다.",
  ...
  bottle: {
    ...
    body: [
      ...
      "프랑스 샹파뉴에서 양조하고, 한국 남해에서 숙성합니다. 수심 30m에서 보낸 시간은 태그로 언제든 다시 열어볼 수 있습니다.",
