...
const fr: MethodCopy = {
  meta: {
    ...
    description:
      "Comment OCEAN CELLAR™, l’IA qui prédit le vieillissement sous-marin, fonctionne à 30 m de profondeur au large de Namhae. Mesurer, prédire, être vérifié, recalibrer.",
  },
  hero: {
    title: "La mer tient un relevé. Nous apprenons à le lire.",
    sub: ["Comment AI OCEAN CELLAR™, qui prédit le vieillissement sous-marin,", "fonctionne à 30 m de profondeur au large de Namhae."],
  },
  ch01: {
    h2: "Nous consignons ce que la mer écrit.",
    p1: "Les eaux au large de Namhae sont mesurées directement par l’Agence hydrographique et océanographique de Corée (KHOA). Chaque mois, nous relevons la température, la salinité et les courants que la mer écrit d’elle-même. Il ne s’agit pas de chiffres inventés, mais du relevé réel de la mer, qui constitue le socle de nos prévisions.",
    ...
    liveLabel: "EN DIRECT · MESURE ACTUELLE",
  ...
  ch03: {
    ...
    p2: "Avoir eu raison ou tort, ce n’est pas à nous de le dire. La mer tranche, et les résultats sont publiés tels quels.",
  ...
  ch04: {
    ...
    certCopy: "L’historique vérifié dans le système devient un certificat associé à la bouteille. Approchez votre téléphone pour accéder aux coordonnées d’immersion, à la profondeur et à la température : le temps que cette bouteille a passé en mer. Aucune bouteille ne ressemble à une autre.",
    certPhone: {
      ...
      rows: [
        { label: "Temps passé en mer", value: "46 mois", accent: true },
  ...
  archive: {
    ...
    lead: "Les données d’immersion, les conditions de la mer et les résultats des vérifications sont tous consignés avec leur date. Pas de mots destinés à séduire, mais le relevé de ce qui a réellement eu lieu.",
...
const ja: MethodCopy = {
  meta: {
    ...
    description:
      "海底熟成を予測するAI、OCEAN CELLAR™が、韓国南岸・南海（ナムヘ）の水深30mで行っていること。記録し、予測し、検証し、補正する。",
  },
  hero: {
    title: "海は記録する。私たちは、その記録の読み方を学んでいる。",
    sub: ["海底熟成を予測するAI OCEAN CELLAR™が", "韓国南岸・南海（ナムヘ）、水深30mで行っていることです。"],
  },
  ch01: {
    h2: "海が刻む変化を、記録する。",
    p1: "南海（ナムヘ）の海は、韓国国立海洋調査院が継続的に観測している海域です。水温、塩分、潮流の観測データを、毎月そのまま受け取って記録します。仮定の数値ではなく、実際の海の記録が、そのまま予測の土台になります。",
    p2: "ボトルが沈む場所は、水深30m。この海域の流れは季節ごとに変わり、ボトルが海中にあるあいだ、観測が止まることはありません。",
    photoAlt: "海底の砂地に置かれた熟成ケージ",
    obsLabel: "直近30日の観測",
    obsSource: "KHOA · OPEN-METEO · 南海（ナムヘ）",
    obsNames: ["水温", "塩分", "潮位", "潮流速度", "水圧", "波高", "波周期", "海流速度"],
    liveLabel: "LIVE · いまこの瞬間の観測",
    livePrefix: { temp: "水温", current: "海流", wave: "波高", pressure: "水圧", salinity: "塩分" },
  },
  ch02: {
    h2: "熟成がたどる道筋を、予測する。",
    lead: "風味が熟成の時間とともにどう変わるのか。それを112,316件のテイスティング記録から学んできました。そのデータを学習したモデルが、六つの軸で風味の変化を予測します。香りのひらき方や気泡の残り方は、物理と化学の法則をもとに補正します。こうして、36ヶ月の変化を一本の予測曲線として描きます。示すのは優劣ではなく、地上とは異なる、もうひとつの熟成です。",
    ...
    radarAria: "投入前と海底熟成12ヶ月後（予測）を比較する風味プロファイルのレーダーチャート",
    ...
    changeNote: "六つの軸がそれぞれに動き、新しいバランスが生まれます。良し悪しではなく、海がもたらす、もうひとつの均衡です。",
  },
  ch03: {
    h2: "引き揚げの日に、予測を検証する。",
    p1: "海底でどう熟成が進むかを予測し、引き揚げの前に書き留めておきます。引き揚げの日には、地上で保管した同じロットの対照ボトルと並べ、比較試飲で予測と結果を照合します。",
    p2: "予測が正しかったかどうかを決めるのは、私たちではありません。答えは海が示し、結果はそのまま公開します。",
  ...
  ch04: {
    ...
    certCopy: "システムに蓄積された検証履歴は、一本ごとの証書として残ります。ボトルにスマートフォンをかざせば、沈めた地点の座標、水深、水温まで、その一本が海で過ごした時間をたどれます。同じ記録は、ひとつとしてありません。",
    certPhone: {
      aria: "ボトルにスマートフォンをかざすとひらく、この一本の記録画面",
      graphTitle: "この一本が過ごした海",
      graphMeta: "46 MONTHS AT SEA",
      seasons: ["2023 冬", "夏", "冬", "2026 冬"],
      rows: [
        { label: "海で過ごした時間", value: "46ヶ月", accent: true },
        { label: "海で重ねた季節", value: "冬 4 · 夏 3" },
