...
const ko: MethodCopy = {
  ...
  ch01: {
    ...
    obsLabel: "최근 30일의 관측",
    obsSource: "KHOA · OPEN-METEO · 완도 해역",
  ...
  ch03: {
    ...
    p2: "맞았는지는 우리가 말하지 않습니다. 바다가 채점하고, 결과는 그대로 공개합니다.",
  ...
  quote: {
    text: "예측을 적어 두고 바다로 나가는 날은 시험을 치르러 가는 기분입니다. 채점은 우리 몫이 아니라는 것, 그걸 아는 게 이 일의 전부입니다.",
    portraitAlt: "배 위에서 해양 관측 대시보드가 열린 태블릿을 든 손",
    attrName: "뮤즈드마레 기록팀",
    attrOrg: "WANDO STATION",
  },
  archive: {
    h2: "이 기록은 매년 발표됩니다.",
    ...
    rows: [
      ...
      { date: "2025 ~ 2026", title: "완도 해역 실측 해양 데이터, 월별 환경 모델", status: "기록 중", accent: false },
...
const en: MethodCopy = {
  ...
  ch01: {
    ...
    obsSource: "KHOA · OPEN-METEO · WANDO WATERS",
  ...
  archive: {
    ...
    rows: [
      ...
      { date: "2025 ~ 2026", title: "Measured ocean data off Wando, monthly environmental model", status: "Recording", accent: false },
...
const fr: MethodCopy = {
  ...
  ch01: {
    ...
    obsSource: "KHOA · OPEN-METEO · EAUX DE WANDO",
  ...
  archive: {
    ...
    rows: [
      ...
      { date: "2025 ~ 2026", title: "Données marines mesurées au large de Wando, modèle mensuel", status: "En cours", accent: false },
