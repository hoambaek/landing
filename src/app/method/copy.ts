...
const ja: MethodCopy = {
  meta: {
    ...
    description:
      "海底熟成を予測するAI、OCEAN CELLAR™が南海の水深30mで行っていること。記録し、予測し、検証を受け、補正します。",
  },
  hero: {
    title: "海は記録します。私たちは、その記録の読み方を学んでいます。",
    sub: ["海底熟成を予測するAI OCEAN CELLAR™が", "南海 水深30mで行っていることです。"],
  },
  ch01: {
    h2: "海が書くものを記録します。",
    p1: "南海は、国立海洋調査院が直接実測している海です。海が書きつづける水温と塩分、潮流を毎月そのまま書き取ります。机の上でつくった数字ではなく、実際の海の記録が、そのまま予測の土台になります。",
  ...
  ch04: {
    ...
    loopH3: "みずから精密になる設計",
    loopCopy: "海へ出る前に、予測を先に書き留めます。引き揚げの日、その予測を実測と並べて置きます。ずれたぶんだけ次の予測が書き直され、引き揚げを重ねるほど、二つの線はしだいに重なっていきます。だから次の一本に記す予測は、年々正確になっていきます。",
    nfcAlt: "フジツボのついた瓶にスマートフォンをかざして記録をひらく手",
    certH3: "その記録が、一本ごとに残ります",
    certCopy: "システムの中で検証された履歴が瓶の外へ出て、証書になります。瓶にかざせば、沈めた海の座標と水深、水温まで、その一本が過ごした時間がひらきます。同じ記録はひとつもありません。",
    certPhone: {
  ...
  quote: {
    text: "予測を書き留めて海へ出る日は、試験を受けに行くような気分です。判定は私たちの手にはない。それを知っていることが、この仕事のすべてです。",
  ...
  archive: {
    h2: "この記録は、毎年発表されます。",
    lead: "観測したデータ、海の条件、検証の結果まで、日付とともに残します。\n飾る言葉ではなく、あったとおりの記録です。",
    ...
    rows: [
      ...
      { date: "2023 ~ 2026", title: "十回を超える沈酒と引き揚げ、予測と確認の繰り返し", status: "累積", accent: false },
    ],
  },
  closing: {
